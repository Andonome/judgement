...
\subsubsection{Weave Facts into Scenes}
\index{Encounters!Descriptions}
and the world will feel a little more solid.
The system can only give you lists of facts, but if you give the players raw facts, they have to memorize them.
Boring!
Take a moment to make one fact interact with the next, and players will understand what's in front of their \glspl{pc}.
...
\begin{itemize}
  ...
  \item
  The \glspl{pc} are in \pgls{broch}, so the pipers will play soon, and try to entice monsters to come, so the archers can shoot them.
  \item
