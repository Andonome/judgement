...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item
    use your own map (\vpageref{makingTheMap}), generate a mission (\vpageref{ngMissions}), prepare the next few encounters (\vpageref{encounters}), and write some \glspl{sq}.
...
\index{Wastmarches Style \Glsfmtplural{campaign}}
...
\subsubsection{Creature \Glsfmtlongpl{cr}}
have been loosely approximated with a formula.
If you want your own creatures to have \pgls{cr}, I recommend just estimating with a glance.
