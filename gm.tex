...
\subsection{Hollering `Initiative'}
helps combat keep up a good pace.
...
\subsection{Speaking Costs}
\pgls{ap}, but it's important that this doesn't become a `gotcha' for any kind of speech.
...
\subsection{To Balance Encounters}
