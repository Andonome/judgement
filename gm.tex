...
On the next session -- whether the characters all work for the \glspl{guard} or some other organization -- the players who arrived will find their characters sit together, in a bar, \gls{broch}, or on the road, and can all begin a new mission together.
...
If the \gls{pc} died on the road, \pgls{jotter} may commission \pgls{bothy} or \gls{broch} where they fell, and name it after them.
This can be an excellent way to commemorate a fallen character over a long period.

\subsubsection{Dismemberment}

If \pgls{pc} is totally out of commission, with 1 \gls{hp} left, 4 \glspl{fatigue} from being bled dry, and a disease nobody can cure, consider letting them play \pgls{npc} and letting them keep all \glspl{xp} gained during this time.
...
In truth, I've seen very few \glspl{pc} die during play.
\Glspl{pc} die rarely because they're careful, and they're careful because they think they might die.

Careful players throw rocks into rooms that look funny, they back off when wounded, and think of practical plans rather than trying to gloriously bonk everything that moves on the head until gold pieces fall out.
