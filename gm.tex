...
\begin{nametable}[cL|L]{Example 1: The Beast}
...
\paragraph{Example 2: The Suspicious Priest}
...
\begin{list}{\sqn}{}
  ...
  \item[\sqr\squash]
  (Villages) A local Seeker (a `priest of Curiosity') offers to tell the party their fortunes.
...
\begin{exampletext}
  ...
  Bandits stole an doula's magical item, and she wants the party to retrieve it.
