...
In the latter case, you can simply give them \glspl{segment} from other \glspl{thread} until they exit the forest.
...
The standard random encounters can interrupt \pgls{thread} \gls{segment}, which makes for a lot of action when you put them all together.
