...
\indexprologue{
  \begin{multicols}{2}
  Each \gls{ingredient} has a symbol showing whether it comes from animals or plants.
  Others are not exactly \glspl{ingredient}, but natural phenomena which boost spells just like \pgls{boon}.
  \columnbreak
  \rotRates
