...
\subsubsection{\Glsfmttext{ainumar}}
...
\subsubsection{\Glsfmtplural{cycle}}
...
\subsubsection{\Glsfmttext{fenestra}'s Crawling Face}

\Gls{fenestra} looks mostly like Earth, but the proportions would make anyone from Earth uneasy.

The world's body is just a touch smaller than Earth's.
People can jump a touch higher, and suffer just a little less from falling from a height.
