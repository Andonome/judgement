...
The \glspl{warden} complain that they insist on a monopoly on cooking \emph{in every warden's home}, and \glspl{warden} who refuse end up poisoned sooner rather than later.
But the \gls{wheat}%
...
are quick to note that nobody with an official \gls{wheat} cook has ever succumbed to poison, so this only shows that everyone should employ one.
...
Not every tavern is a temple, but the bigger the town, the more keen the \gls{wheat} will feel on establishing themselves in the area.
...
\begin{itemize}
  ...
  \item
  Either side gets -3 for insulting the warden.
\end{itemize}

The jester is fickle, the crowds love a twist, and the warden's patience grows thin.
...
\begin{dlist}
  ...
  \item
  The warden feels lenient -- everyone goes free.
\end{dlist}
...
Every town has a wing of the \gls{weaverGuild}.
...
The wardens generally think of the \gls{guard} as a protection racket -- stop payment, and you could lose \pgls{village}.
