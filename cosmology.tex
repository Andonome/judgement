...
\setcounter{ainumarPosition}{360}
\newcounter{fenestraPosition}
\setcounter{fenestraPosition}{90}

\boxPair{
  Season: \arabic{season}
  \divide\value{ainumarPosition} by \value{season}
  \multiply\value{ainumarPosition} by 3
  \begin{tikzpicture}
    \coordinate (S) at (0,0);
