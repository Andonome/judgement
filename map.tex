...
\begin{itemize}
  ...
  \item
  Place a valley of hills in the centre of the mountain range.
\end{itemize}
...
\begin{enumerate}
  ...
  \item
  Rivers flow off the map once they have nowhere else to go.
\end{enumerate}
...
\begin{enumerate}
  \item
  At each point on the coast, add $1D6-1$ islands.
  \item
  At each human settlement, draw $1D6$ \glspl{broch}.
  They sit around 2 to 4 miles apart, guarding the \glspl{village} between them.
  \item
  Connect each human settlement to every other settlement with \pgls{lonelyRoad} or (if available) sea route.
  \begin{itemize}
    \item
  ...
  \label{roadOut}
  \item
  If a dwarvish settlement has human neighbours, it connects with another road.
  \item
