...
\item
  ...
  \end{itemize}
  \item
  For each town, draw a river directly from the mountains (or the closest body of water).
  \begin{itemize}
  \item
...
\begin{dlist}
  ...
  \item
  \underline{Warlord}, amassing an army to expand their power.
  Shipments of weapons come from the road to other lands.
  \item
  \underline{Opulent noble}, who demands 20\% tithes from all who enter.
  The local oddities annoy and fascinate them equally (from step \ref{mapOddities}).
  \item
  \underline{Sorcerer king} with no experience or business ruling.
  ...
  \item
  \underline{Spoilt noble} who has never seen a peasant.
  \item
  \underline{A servant of the next fiend} you roll (see step \ref{fiendTypes}).
  All who oppose them die on the road.
  \item
  \underline{A crime-lord}, with a history of theft, now risen to fortune\ldots but not nobility.
...
\begin{enumerate}
  ...
  \item
  Find the longest road with the biggest populations around it, and place a Lonely Tavern in the middle of the road (see \autopageref{lonelyTaverns}).
  Mark it as point `7'.
  \item
...
\mapentry[fiendDesires]{The Fiend Wants}
...
Each time the \glspl{pc} forage, they roll Intelligence + Vigilance (\tn{12}) to figure out where the best loot lies.
