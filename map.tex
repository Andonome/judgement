...
If the area has a town, roll $1D6$ to determine its ruler.
...
\begin{dlist}
  ...
  \item
  Foolishness and bad luck lead to an unlikely series of calamities for this area.
  The local \glspl{warden} began a war with the lowest civilised point and lost.
  When the \gls{warden} pushed criminals into the \gls{sunGuard} rather than the \gls{guard}, the area had nobody left to guard it, and predators from the forest began to creep in, more and more.
