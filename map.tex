...
If this point has a town in its centre, roll $1D6$ to determine its ruler.
...
\begin{dlist}
  ...
  (find \nameref{screeching_moss} on \autopageref{screeching_moss})
  \item
...
\begin{exampletext}
  ...
  Since the city has demiliches and chitincrawlers, it makes sense that the demiliches would want to use the chitincrawlers' bodies as \glspl{ingredient} for witchcraft.
