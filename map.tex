...
Each point on the map needs more detail, but they don't need more time yet.
Decide where the \glspl{pc} will begin (perhaps the lowest \gls{village}?) ten add some detail to that point, and perhaps a few neighbouring points.

Whenever the \glspl{pc} approach a new area, you can roll a few dice to find out what stays there.
