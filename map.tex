\chapter[The Cartographers]{Civilization}
\label{civilization}
...
\begin{enumerate}
  ...
  Mark it as point `7'.
  \item
  Every road over 10 miles long should have a \gls{bothy}.
  People rely on these little stone houses to keep themselves and their horses safe at night.
...
The beasts often remain, permanently, which creates a tantalizing trap for anyone around.
Some treasures always remain in lost cities -- coinage, statues, weapons, and often more secrets, as one builds deeper underground.
