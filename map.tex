...
\begin{enumerate}
  ...
  \item
  If a fourth river adds its strength, they all form a lake.
  
  The lake exits towards the lowest neighbour as another thick line (with the strength of two rivers).
  \item
...
\begin{enumerate}
  ...
  \begin{itemize}
    ...
    \item
    If a canyon or lake blocks a road, people may find another way around, or may just have to row across the river, or descend into the canyon.
  \end{itemize}
  \item
