...
\begin{enumerate}
  ...
  \end{itemize}
  \item
  If any road stretches for 40 miles or more, place \gls{lonelyTavern} half-way along that road (details \vpageref{lonelyTaverns}).
  \item
  The road between points takes a long time to walk.
  Put \pgls{bothy} on the road for every 10 miles of distance.
\end{enumerate}
