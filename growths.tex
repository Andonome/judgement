...
\disease{Raknid Sweats}%
  {%
    ...
    The loss of fluids adds \pgls{ep}, and the rank smell stops anyone in the same room from sleeping.
    But not everything hates the smell.
    ...
    The illness subsides quickly, and then returns after 2~\glspl{interval} of respite, with sweats so bad they drain 2~\glspl{ep}.
    ...
    At this point, most become accustomed to their own smell, and can finally sleep through the sweats (though you never get used to someone else's).
  }%
  {Fire}%
  {10}
