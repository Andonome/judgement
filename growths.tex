...
\funkyPlant{Marching Mushroom}%
  ...
  Chewing on this tough mushroom relieves tiredness, but slows both the body and mind.
    Ignore \gls{fatigue} penalties for 6 \glspl{interval}, but with -1 penalty to Dexterity, Speed, Intelligence and Wits.
...
\funkyPlant{Screechmoss}%
  ...
  {\roll{Intelligence}{Medicine}}%
  {12}%
  {The air turns foul, everyone in the \gls{area} gains \pgls{fatigue}.}%
