...
\renewcommand\statblock[1]{
      ...
      \ent{\Glsfmtplural{attribute}} &
        {\scshape Str}~\arabic{Strength},
        {\scshape Dex}~\arabic{Dexterity},
        {\scshape Spd}~\arabic{Speed},
        \ifnum\value{Intelligence}>-6%
          {\scshape Int}~\arabic{Intelligence},
        \fi%
        {\scshape Wts}~\arabic{Wits}%
        \ifnum\value{Charisma}>-6%
          , {\scshape Cha}~\arabic{Charisma}
        \fi%
...
\begin{tcolorbox}[ornamented]
  ...
  Anyone still here, go help the salt-seller.
