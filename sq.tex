...
In order to wrap up \pgls{campaign} cleanly, you need some `plot-buffer', where no more \glspl{sq} begin.
You need \pgls{sq} with nothing but random, unconnected events in the \gls{region}.
...
\sidequest[Roads]{Random Events on the Road}
