...
The first thing to do is change where the \gls{witch}'s lives.
...
This leaves the players thinking about multiple plot-arcs simultaneously, a chasing multiple leads.
...
is \pgls{segment}.
You can think of `\gls{segment}' like a scene with one stipulation, to remove the final nail from those rail-tracks; the end of all \glspl{segment} remains empty until the \glspl{pc} arrive.
