...
\begin{dlist}
  \item[\encCivilization] a roll of \dicef{\value{dlist}} indicates a caravan with \arabic{dlist} useful item.

  \item[\encCivilization]
  a roll of \dicef{\value{dlist}} or less means a caravan with up to \arabic{dlist} useful items.
