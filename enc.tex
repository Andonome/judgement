...
will block all travel across an area for \pgls{interval}, and everyone in the area has to flee or seek shelter.
Groups use a single \gls{natural} roll of \roll{Speed}{Athletics} (\tn[10]) to determine the outcome for everyone.
Anyone who fails becomes buried; they break free with \roll{Strength}{Wyldcrafting} (\tn[10]), or remain buried forever.
...
During warm seasons, a roll of \dicef{3} \dicef{4} means \pgls{woodspy}, but during cold \gls{Alassea} and \gls{Minquesta}, it means a warthog, as they become more aggressive when food becomes scarce.
