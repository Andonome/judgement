...
Each one begins life as \pgls{bothy}, and if they receive enough stone, the \gls{guard} can use them as defensive towers.
...
For example, once the troupe reach \pgls{village}, the \gls{gm} might roll $3D$ for the following result:

\diceTrio{2}{3}{1}{Copper Spikes}{Moat}{Roast Griffin}
