...
Roll their Combat or Brawl Skill at \gls{tn} 7.
...
This group roll counts for everyone, so if the group roll a total of \gls{tn} 8, but one member is wounded, that member will fail the roll and flee, while the others stay.
