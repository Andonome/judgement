...
A standard \gls{broch} should contain a fireplace, pre-cut wood, and an axe to get more firewood.
Travellers expect people to leave the place in good repair, and nobody will trust someone known to leave \pgls{broch} in a bad state.

People build \glspl{broch} when someone has fallen to the forest while travelling, so each \gls{broch} doubles as a cenotaph.
Give each one a random name (usually human), such as `Mukrake \Gls{broch}'.
