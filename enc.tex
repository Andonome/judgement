...
This chapter covers wandering \glspl{monster} -- the heart of \gls{fenestra}.
...
For every week which passes in our world, thirty days pass over there.

\setcounter{track}{\month}
\setCycle{\month}{\day}
While we have \trackMonth, \gls{fenestra} has `\showCycle' -- a \showTemperature\ season.
After three months, all six \glspl{cycle} have passed and a new cycle begins.
