...
\newcommand\encLine{
  \stepDown{enc} & \stepDown{diceNo} & \stepDown{diceNo2} &
}

\newenvironment{encChart}[2][c|c|c|L]%
  {
    \setcounter{enc}{12}
    \setcounter{diceNo}{14}
    \setcounter{diceNo2}{16}
    ...
    \tabularx{\linewidth}{#1}
      \hline
      \hline
      \textbf{Warm} & \textbf{Mild} & \textbf{Cold} & \textbf{Encounter} \\
      \hline
  }%
  {
      \hline
