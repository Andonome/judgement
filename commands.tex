...
\newcommand\encTownEvents{
  ...
  \dicef{2} & \dicef{4} &
              ...
              \\
  \dicef{1} & \dicef{3} & A merchant is selling basilisk flesh which he found on the side of the road.  When guards ask if he took the basilisk recently killed by the \gls{guard}, he says `no', and that his cousin sold it to him. &
