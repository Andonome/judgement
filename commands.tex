...
\newcommand\encTownEvents{
  ...
  \Large\dicef{3} & \Large\dicef{5} &
              ...
              A dozen patrons, complaining about local crime.
              \\
  ...
  \Large\dicef{1} & \Large\dicef{3} & A merchant is selling basilisk flesh which he found on the side of the road.  When guards ask if he took the basilisk recently killed by the \gls{guard}, he says `no', and that his cousin sold it to him. &
              A slap-fight breaks out between two Seekers, as one won't tell the other the answer to a riddle.
  \\
            & \Large\dicef{2} &
            ...
            & \Large\dicef{1} &
                        ...
                        The barkeep is raving at people to fetch him a doula for his illness (Mindflash Syndrome, \autopageref{Mindflash Syndrome}), but none will come since he insulted one last year.
                        \\
  \hline
  \end{wideTable}
}
...
\newcommand\bothyEvents{
  ...
  \item
  A dozen \glspl{guard} sleep here, with a jotter upstairs.
  \item
...
\newcommand\encVillageFeatures{
  ...
  \stepcounter{dlist}
    \item
    Screech Moss grows along the old, outer walls (\autopageref{screeching_moss}).
    \item
    ...
    Dead crows litter the area, indicating that the plan has some problems.
    \item
  ...
  \begin{enumerate}
    ...
    A travelling tradesman wants you to
      \begin{dlist}
        ...
        anything you maybe haven't reported to the jotter\ldots
