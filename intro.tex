...
\begin{itemize}
  ...
  \item
  Over chapters \reftextlabelrange{fiends}{growths}, the book lists out the various dangers of the great, wild, world, and provides answers to age-old questions, such as `where do \glspl{basilisk} hibernate over the cold seasons?', and `what do griffins eat aside from people?'.
  \item
...
for working out how seasons should work in \autoref{cosmology}.
