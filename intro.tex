...
\begin{itemize}
  ...
  \item
  Over chapters \reftextlabelrange{fiends}{growths}, the book lists out the various dangers of the great, wild, world, and provides answers to age-old questions, such as `where do basilisks hibernate over the cold seasons?', and `what do griffins eat aside from people?'.
  \item
