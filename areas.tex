...
\item
  War brews with whoever lives on the next point on the map.
...
\item
  If any islands sit alone and unconnected, connect their nearest shore to the next point with a town.
\end{itemize}
...
The \gls{tn} is normally 7, but often easier.
...
\begin{itemize}
  ...
  -1 in a storm.
  \item
  -2 if the fiends are busy with battle.
  \item
  +2 if lighting an indoor, well-protected fire.
  \item
  +5 if lighting an open fire.
\end{itemize}
