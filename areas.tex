...
\item
  ...
  \footnote{Draw routes from uninhabited points.
  We will find out what lives there later.}
\end{enumerate}
...
\begin{enumerate}
  \item
  At each town, draw a road to every other town, which winds through any villages along the way.
  \begin{itemize}
    \item
    Where the roads cross water, draw a small bridge.
  \end{itemize}
