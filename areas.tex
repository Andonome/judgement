...
\begin{enumerate}
  \item
  At each town, draw a road to the next town, which winds through any villages along the way.
  \begin{itemize}
    \item
    Where the roads cross water, draw a small bridge.
  \end{itemize}
  ...
  \item
  Find the longest road with the biggest populations around it, and place a Lonely Tavern (see \autopageref{lonelyTaverns}), and mark it as point `7'.
  \item
...
\begin{itemize}
  ...
  \item
  For extra credit, find a small section of your map, covering only two points, and make a new map based on it to give to your players.
\end{itemize}
