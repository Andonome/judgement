...
\begin{nametable}[c|p{.4\textwidth}|L|L]{Foraging}
  ...
  \textbf{6} & Under a hidden floorboard -- broken patches show something underneath & \lootJewellery & \lootMagic \\

  \textbf{5} & Hidden room, behind an old bookcase & \lootBig & Lowest numbered dweller with \arabic{r4} \\

  \textbf{4} & An empty home, just inside an dark and empty doorway & \lootJewellery & \lootBig \\

  \textbf{3} & Sitting in the centre of an expensive family home, where skeletons remain, fully clothed. This family left on their own terms. & \lootMedium & \lootJewellery \\

  \textbf{2} & Behind a fully stone door, clearly used as a safe.
  Opening it prompts a second & \lootJewellery & \lootMagic  \\

  \textbf{1} & Lying under a pile of bones & \lootBig & \lootMagic \\
...
Roll $4D6$ to find how many tall buildings lie in the area.
...
When the \glspl{pc} want to move through a lost city, they make a group roll of Dexterity + Stealth (\gls{tn} 10) to remain quiet.

\begin{itemize}
  \item
  +1 if moving at night (when the animals see less well, and the undead have other business to attend to.
  \item
  +1 in the rain.
  \item
  +1 in a storm.
  \item
  -1 for foraging for valuables.
\end{itemize}
